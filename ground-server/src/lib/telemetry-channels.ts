...
export const TELEMETRY_CHANNELS: TelemetryChannel[] = [
  ...
  },
  {
    ...
    dbMeasurements: ["Umbilical", "Fill Radio", "Ground Radio"],
    dbField: "alt_armed",
    widgets: [BoolStateWidget("Armed", "Disarmed"), BoolLightWidget(), EventCounterWidget()],
  },
  {
    label: "Altimeter Valid",
    dbMeasurements: ["Umbilical", "Fill Radio", "Ground Radio"],
    dbField: "alt_valid",
    widgets: [BoolStateWidget("Valid", "Off"), BoolLightWidget(), EventCounterWidget()],
  },
  {
    label: "GPS Valid",
    dbMeasurements: ["Umbilical", "Fill Radio", "Ground Radio"],
  ...
  },
  {
    ...
    widgets: [BoolStateWidget("Fresh", "Stale"), BoolLightWidget(), EventCounterWidget()],
  },
  {
    label: "MAV State",
    dbMeasurements: ["Umbilical", "Fill Radio", "Ground Radio"],
    dbField: "mav_state",
    widgets: [BoolStateWidget("On", "Off"), BoolLightWidget(), EventCounterWidget()],
  },
  {
    label: "SV2 State",
    dbMeasurements: ["Umbilical", "Fill Radio", "Ground Radio"],
  ...
  },
  {
    ...
    widgets: [BoolStateWidget("True", "False"), BoolLightWidget(), EventCounterWidget()],
  },
  {
