...
grpcurl -plaintext -d '{"bv1_open": true}' localhost:50051 command.Commander/SendCommand
grpcurl -plaintext -d '{"bv1_open": false}' localhost:50051 command.Commander/SendCommand
grpcurl -plaintext -d '{"bv1_off": true}' localhost:50051 command.Commander/SendCommand
grpcurl -plaintext -d '{"bv1_off": false}' localhost:50051 command.Commander/SendCommand
...
expected_output=$(cat ./fill/test/bv_test_expected_output.txt)
